        ...
        <tbody>
          {viewApplicationsPageData.map((applicant, index)=>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b-2 border-gray-200 max-sm:hidden'>
                  {applicant.jobTitle}
                </td>
                <td className='py-2 px-4 border-b border-gray-200 max-sm:hidden'>{applicant.location}</td>
                <td className='py-2 px-4 border-b border-gray-200'>
                  <a href="" target='_blank' className='bg-blue-50 text-blue-400 rounden inline-flex gap-2 items-center px-3 py-2'>

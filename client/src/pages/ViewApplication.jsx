...
const ViewApplication = () => {
  ...
  // funcction to fetch company job applications data
  ...
  // function to update the job applications status
            ...
            {applicants.filter(item => item.jobId && item.userId ).map((applicant, index) => (
              <tr key={index} className="text-gray-700">
                ...
                <td className="py-2 px-4 border-b border-gray-200 flex items-center gap-2">
                  <img
                    className="w-10 h-10 rounded-full mr-2 max-sm:hidden"
                ...
                <td className="py-2 px-4 border-b border-gray-200">
                  <a
                    ...
                    className="bg-blue-50 text-blue-500 rounded inline-flex gap-2 items-center px-3 py-2"
                  >
                    Resume
                    <img
                ...
                <td className="py-2 px-4 border-b border-gray-200">
                 ...
                 <div className="relative inline-block text-left group">
                    ...
                    <div className="z-10 hidden absolute right-0 md:left-0 top-6 mt-1 w-32 bg-white border border-gray-200 rounded shadow group-hover:block">
                      <button
